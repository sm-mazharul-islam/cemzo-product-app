...
- **Clean Separation of Concerns:** Core API calls are entirely abstracted into an isolated infrastructure service layer (`src/services/api.js`), ensuring UI components remain clean and stateless.
